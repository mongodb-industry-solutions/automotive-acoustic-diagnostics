...
- **License**: PSF-2.0
- **Author**: UNKNOWN
- **Repository**: https://github.com/AbstractUmbra/audioop
...
- **Repository**: http://cffi.readthedocs.org
...
- **Repository**: https://github.com/scientific-python/lazy_loader

### librosa@0.11.0
- **License**: ISC License (ISCL)
- **Author**: Brian McFee, librosa development team
- **Repository**: https://librosa.org

### llvmlite@0.44.0
- **License**: BSD
- **Author**: UNKNOWN
- **Repository**: http://llvmlite.readthedocs.io
...
- **Repository**: http://mpmath.org/

### msgpack@1.1.1
- **License**: Apache 2.0
- **Author**: Inada Naoki <songofacandy@gmail.com>
- **Repository**: https://msgpack.org/
...
- **License**: BSD License
- **Author**: UNKNOWN
- **Repository**: https://numba.pydata.org
...
- **Repository**: https://github.com/qiuqiangkong/panns_inference
...
### pooch@1.8.2
- **License**: BSD License
- **Author**: The Pooch Developers <fatiandoaterra@protonmail.com>
- **Repository**: https://www.fatiando.org/pooch/latest/changes.html
...
- **License**: Python Software Foundation License
- **Author**: Python Developers <python-deadlib@youknowone.org>
...
- **License**: MIT License
- **Author**: Qiuqiang Kong
- **Repository**: https://github.com/qiuqiangkong/torchlibrosa
