...
def insert_mongo_results(results, mongodb_results_collection):
    ...
    entry = {"sensor":"Engine Demo","data_time":datetime.now(),"results":results}
...
audio_description_dictionary = [
    ...
    {
      "audio": "Running Normally",
      "image": "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExaHVyNGh6bTFtcXZwMHZ0NzdqY2c5czV3NDNycTVxcTRxOWE3NzIzYiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/WSqsdbIH6mLrHe78tJ/giphy.gif"
    },
    {
      "audio": "Metallic Hit",
      "image": "https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExc2tnNGR5ZGg1YmxtOTB0cnd3NWY4OXY3bzRpb3Vhbm01ODRvMDFtYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/MdkW7kosS2c0QJzlni/giphy.gif"
    },
    {
      "audio": "Soft Material Hit",
      "image": "https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExc2tnNGR5ZGg1YmxtOTB0cnd3NWY4OXY3bzRpb3Vhbm01ODRvMDFtYyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/MdkW7kosS2c0QJzlni/giphy.gif"
    }
  ]
